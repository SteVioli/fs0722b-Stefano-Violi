...
function epify(str){// function per comparare il carattere/i  /esimo di due stringhe
    let textStr = str.substring(0,7) // gli diciamo di prendere la sottostringa dei primi 6 caratteri
    if(textStr != epi){return str = epi + str;}
    else return str;
}
console.log(epify('EPICODE'))
console.log(epify('EPICOaaaaa'))*/
...
check3and7(22); */
// per fare sto check non serve fare il console.log ma basta avviare la funzione
...
/*const reverseString = function(string){
    return string.split("").reverse().join("")//split divide la parola facendo un array con tutte le lettere, poi le rovescia e con join le rimette
}
